                ...
                return Column(
                  ...
                  children: [
                          ...
                          IconButton(
                              onPressed: () {
                                context.go(StartWorkoutPage(
                                  workoutModel: widget.workouts[widget.indexA],
                    ...
                    ListView.builder(
                            ...
                            child: IgnorePointer(
                              ...
                              child: ExpansionTile(
                                ...
                                title: Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Text(widget.workouts[widget.indexA]
                                          .workouts[index].name),
                                    ),
                                    const SizedBox(
                                      width: 20,
                                  ...
                                  Column(
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Image.network(
                                            value[widget.workouts[widget.indexA]
                                                        .workouts[index].id -
                                                    1]
                                                .move_img
                                                .toString(),
                      ...
                      itemCount: widget.workouts[widget.indexA].workouts.length,
                    ),
                  ],
                );
